...
export const mockBusinesses: Business[] = [
  {
    ...
    address: "Praia dos Anjos, s/n — Marina",
    lat: -22.9736,
    lng: -42.0189,
    meetingPoint: "Na Praia dos Anjos, em frente à capela, 30 minutos antes da saída.",
    ...
    tours: [
      {
        id: "t1",
        title: "Passeio de barco para observação de baleias",
        priceFrom: 220,
        durationHours: 4,
        cancellationPolicy: "moderada",
        capacityPerDay: 12,
        departureTimes: "08:00 e 13:30",
        groupSize: 12,
        languages: "Português e inglês",
        included: "Guia credenciado, colete salva-vidas, água e fruta.",
        bring: "Protetor solar, boné, corta-vento e roupa de banho.",
      },
  ...
  },
  {
    ...
    address: "Praça Daniel Barreto, Centro",
    lat: -22.9661,
    lng: -42.0278,
    meetingPoint: "No coreto da praça, camiseta verde do Avena.",
