...
export const pt = {
  ...
  "wish.subtitle": "O mapa guarda onde você já esteve. Aqui fica o que ainda falta — passeios do Avena e destinos que você sonha, mesmo que ainda não tenha parceiro por lá.",
  "wish.add": "Quero fazer",
  "wish.saved": "Está na sua lista",
  "wish.addToList": "Adicionar à lista",
  "wish.whatField": "O que você quer fazer",
  "wish.whatPlaceholder": "Ex.: ver o pôr do sol no Jalapão",
  "wish.cityField": "Cidade (opcional)",
  "wish.noteField": "Anotação (opcional)",
  "wish.notePlaceholder": "Melhor época, com quem ir, quanto pretende gastar…",
  "wish.count": "{count} na sua lista",
  "wish.countOne": "1 na sua lista",
  "wish.empty": "Sua lista está vazia. Adicione acima, ou toque em “Quero fazer” em qualquer passeio.",
  ...
  "wish.seeOptions": "Ver opções nesse destino",
  "wish.registerMemory": "Registrar como memória",
  "wish.partnersHere": "{count} parceiros do Avena em {city}.",
  "wish.noPartnersYet": "Ainda não temos parceiros em {city}. Guardamos seu interesse — é assim que decidimos onde buscar agências.",
