...
insert into public.professionals (id, owner_id, name, category, categories, city, bio, phone, entity_type)
values ('eeeeeeee-0000-0000-0000-000000000010', 'eeeeeeee-0000-0000-0000-000000000001',
        'Estúdio Lemos', 'Fotógrafo', array['Fotógrafo','Filmagem'], 'Itabirito', 'Casamentos', '(31) 90000-0001', 'pf');
...
values ('eeeeeeee-0000-0000-0000-000000000011', 'eeeeeeee-0000-0000-0000-000000000001',
        'Aulas com Léo', 'Professor de música', array['Professor de música'], 'Itabirito', 'Violão', '(31) 90000-0002', 'pf');

-- 2. Repetir um serviço que já existe: barrado.
do $$
begin
  begin
    insert into public.professionals (owner_id, name, category, categories, city, bio, phone, entity_type)
    values ('eeeeeeee-0000-0000-0000-000000000001', 'Fotos Lemos 2', 'Fotógrafo',
            array['Fotógrafo'], 'Itabirito', 'Mais fotos', '(31) 90000-0003', 'pf');
...
values ('eeeeeeee-0000-0000-0000-000000000001', 'Estúdio Lemos Ouro Preto', 'Fotógrafo',
        array['Fotógrafo'], 'Ouro Preto', 'Casamentos', '(31) 90000-0004', 'pf');
...
values ('eeeeeeee-0000-0000-0000-000000000001', 'Marido de aluguel', 'Marido de aluguel',
        array['Marido de aluguel'], 'Itabirito', 'Reparos', '(31) 90000-0005', 'pf'),
       ('eeeeeeee-0000-0000-0000-000000000001', 'Jardins', 'Jardineiro',
        array['Jardineiro'], 'Itabirito', 'Jardins', '(31) 90000-0006', 'pf');
...
begin
  begin
    ...
    values ('eeeeeeee-0000-0000-0000-000000000001', 'Sexto', 'Chaveiro',
            array['Chaveiro'], 'Itabirito', 'Chaves', '(31) 90000-0007', 'pf');
