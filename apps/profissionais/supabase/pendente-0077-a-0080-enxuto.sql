-- Ei Itabirito — migrations 0077 a 0080, em uma parte só.
-- Cole tudo, clique uma vez no editor (para não ficar nada selecionado) e
-- toque em Run. No fim ele responde sozinho se deu certo.
...
-- ── A conferência: é esta resposta que vale ──────────────────────────
select case
  ...
  then 'PRONTO — pode fechar'
  else 'AINDA FALTA — me mande o erro que apareceu'
  end as resultado;
