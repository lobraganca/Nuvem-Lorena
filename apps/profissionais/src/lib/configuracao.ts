...
export async function verificarConfiguracao(): Promise<ItemConfig[]> {
  ...
  return [
    ...
    },
    {
      ...
      consequencia:
        "Sem isto, pausar dá erro — e o dono de um cadastro suspenso consegue se reativar sozinho.",
