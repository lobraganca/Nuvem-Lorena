...
/**
 * Um símbolo por ofício, para os cartões de categoria da tela de busca.
 *
 * O ponto é distinguir, não decorar: uma grade em que todos os cartões
 * trazem a mesma maleta não ajuda ninguém a achar o que procura — o olho
 * passa por oito ícones idênticos e continua tendo que ler as oito
 * palavras. Símbolos diferentes fazem o cartão ser reconhecido antes de
 * ser lido, que é a única razão de existir um ícone ali.
 *
...
const SIMBOLOS_DE_SERVICO: Record<string, string> = {
  // Casa e obra
  "Encanador": "🚿", "Eletricista": "💡", "Pedreiro": "🧱", "Pintor": "🎨",
  "Marceneiro": "🪵", "Serralheiro": "⚙️", "Vidraceiro": "🪟", "Gesseiro": "🏗️",
  "Marido de aluguel": "🧰", "Montador de móveis": "🔩", "Chaveiro": "🔑",
  "Jardineiro": "🌱", "Piscineiro": "🏊", "Dedetizador": "🐜", "Diarista": "🧽",
  "Passadeira": "👔", "Cuidador de idosos": "🤝", "Babá": "🍼",
  // Técnica e conserto
  ...
  "Maquiadora": "💄", "Estética e sobrancelhas": "✨", "Massagista": "💆",
  "Personal trainer": "🏋️", "Nutricionista": "🥗", "Fisioterapeuta": "🦴",
  "Psicólogo": "🧠",
  // Ensino
  "Professor particular": "📚", "Professor de inglês": "🗣️",
  "Professor de música": "🎵", "Reforço escolar": "✏️", "Palestrante": "🎤",
  // Festas e imagem
  "Fotógrafo": "📷", "Filmagem": "🎥", "Confeiteira": "🎂", "Salgadeira": "🥟",
  "Cozinheira": "🍲", "Buffet e festas": "🎉", "DJ e som": "🎧",
  "Decoração de festas": "🎈",
  // Costura e artesanato
  "Costureira": "🧵", "Sapateiro": "👞", "Tapeceiro": "🛋️", "Artesanato": "🧶",
  // Transporte
  "Frete e mudanças": "🚚", "Motorista": "🚙", "Motoboy": "🛵",
  ...
  "Ótica": "👓",
  // Saúde e exames
  "Laboratório de análises": "🧪", "Clínica médica": "🩺",
  "Clínica odontológica": "🦷", "Fonoaudiólogo": "👂",
  "Terapeuta ocupacional": "🧩", "Enfermagem em casa": "💉",
  "Exames de imagem": "🩻",
...
export function simboloDoServico(categoria: string): string {
  return SIMBOLOS_DE_SERVICO[categoria] ?? "🧰";
}
